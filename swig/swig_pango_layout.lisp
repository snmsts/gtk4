...
(cffi:defcstruct #.(swig-lispify "_PangoLayoutLine" 'classname)
	(#.(swig-lispify "layout" 'slotname) :pointer)
	(#.(swig-lispify "start_index" 'slotname) :int)
	(#.(swig-lispify "length" 'slotname) :int)
	(#.(swig-lispify "runs" 'slotname) :pointer)
	(#.(swig-lispify "is_paragraph_start" 'slotname) :unsigned-int)
	(#.(swig-lispify "resolved_dir" 'slotname) :unsigned-int))

(cl:export '#.(swig-lispify "_PangoLayoutLine" 'classname))

(cl:export '#.(swig-lispify "layout" 'slotname))

(cl:export '#.(swig-lispify "start_index" 'slotname))

(cl:export '#.(swig-lispify "length" 'slotname))

(cl:export '#.(swig-lispify "runs" 'slotname))

(cl:export '#.(swig-lispify "is_paragraph_start" 'slotname))

(cl:export '#.(swig-lispify "resolved_dir" 'slotname))

(cffi:defcfun ("pango_layout_get_type" #.(swig-lispify "pango_layout_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_layout_get_type" 'function))

(cffi:defcfun ("pango_layout_new" #.(swig-lispify "pango_layout_new" 'function)) :pointer
  (context :pointer))

(cl:export '#.(swig-lispify "pango_layout_new" 'function))

(cffi:defcfun ("pango_layout_copy" #.(swig-lispify "pango_layout_copy" 'function)) :pointer
  (src :pointer))

(cl:export '#.(swig-lispify "pango_layout_copy" 'function))

(cffi:defcfun ("pango_layout_get_context" #.(swig-lispify "pango_layout_get_context" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_context" 'function))

(cffi:defcfun ("pango_layout_set_attributes" #.(swig-lispify "pango_layout_set_attributes" 'function)) :void
  (layout :pointer)
  (attrs :pointer))

(cl:export '#.(swig-lispify "pango_layout_set_attributes" 'function))

(cffi:defcfun ("pango_layout_get_attributes" #.(swig-lispify "pango_layout_get_attributes" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_attributes" 'function))

(cffi:defcfun ("pango_layout_set_text" #.(swig-lispify "pango_layout_set_text" 'function)) :void
  (layout :pointer)
  (text :string)
  (length :int))

(cl:export '#.(swig-lispify "pango_layout_set_text" 'function))

(cffi:defcfun ("pango_layout_get_text" #.(swig-lispify "pango_layout_get_text" 'function)) :string
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_text" 'function))

(cffi:defcfun ("pango_layout_get_character_count" #.(swig-lispify "pango_layout_get_character_count" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_character_count" 'function))

(cffi:defcfun ("pango_layout_set_markup" #.(swig-lispify "pango_layout_set_markup" 'function)) :void
  (layout :pointer)
  (markup :string)
  (length :int))

(cl:export '#.(swig-lispify "pango_layout_set_markup" 'function))

(cffi:defcfun ("pango_layout_set_markup_with_accel" #.(swig-lispify "pango_layout_set_markup_with_accel" 'function)) :void
  (layout :pointer)
  (markup :string)
  (length :int)
  (accel_marker :unsigned-int)
  (accel_char :pointer))

(cl:export '#.(swig-lispify "pango_layout_set_markup_with_accel" 'function))

(cffi:defcfun ("pango_layout_set_font_description" #.(swig-lispify "pango_layout_set_font_description" 'function)) :void
  (layout :pointer)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_layout_set_font_description" 'function))

(cffi:defcfun ("pango_layout_get_font_description" #.(swig-lispify "pango_layout_get_font_description" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_font_description" 'function))

(cffi:defcfun ("pango_layout_set_width" #.(swig-lispify "pango_layout_set_width" 'function)) :void
  (layout :pointer)
  (width :int))

(cl:export '#.(swig-lispify "pango_layout_set_width" 'function))

(cffi:defcfun ("pango_layout_get_width" #.(swig-lispify "pango_layout_get_width" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_width" 'function))

(cffi:defcfun ("pango_layout_set_height" #.(swig-lispify "pango_layout_set_height" 'function)) :void
  (layout :pointer)
  (height :int))

(cl:export '#.(swig-lispify "pango_layout_set_height" 'function))

(cffi:defcfun ("pango_layout_get_height" #.(swig-lispify "pango_layout_get_height" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_height" 'function))

(cffi:defcfun ("pango_layout_set_wrap" #.(swig-lispify "pango_layout_set_wrap" 'function)) :void
  (layout :pointer)
  (wrap #.(swig-lispify "PangoWrapMode" 'enumname)))

(cl:export '#.(swig-lispify "pango_layout_set_wrap" 'function))

(cffi:defcfun ("pango_layout_get_wrap" #.(swig-lispify "pango_layout_get_wrap" 'function)) #.(swig-lispify "PangoWrapMode" 'enumname)
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_wrap" 'function))

(cffi:defcfun ("pango_layout_is_wrapped" #.(swig-lispify "pango_layout_is_wrapped" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_is_wrapped" 'function))

(cffi:defcfun ("pango_layout_set_indent" #.(swig-lispify "pango_layout_set_indent" 'function)) :void
  (layout :pointer)
  (indent :int))

(cl:export '#.(swig-lispify "pango_layout_set_indent" 'function))

(cffi:defcfun ("pango_layout_get_indent" #.(swig-lispify "pango_layout_get_indent" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_indent" 'function))

(cffi:defcfun ("pango_layout_set_spacing" #.(swig-lispify "pango_layout_set_spacing" 'function)) :void
  (layout :pointer)
  (spacing :int))

(cl:export '#.(swig-lispify "pango_layout_set_spacing" 'function))

(cffi:defcfun ("pango_layout_get_spacing" #.(swig-lispify "pango_layout_get_spacing" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_spacing" 'function))

(cffi:defcfun ("pango_layout_set_line_spacing" #.(swig-lispify "pango_layout_set_line_spacing" 'function)) :void
  (layout :pointer)
  (factor :float))

(cl:export '#.(swig-lispify "pango_layout_set_line_spacing" 'function))

(cffi:defcfun ("pango_layout_get_line_spacing" #.(swig-lispify "pango_layout_get_line_spacing" 'function)) :float
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_line_spacing" 'function))

(cffi:defcfun ("pango_layout_set_justify" #.(swig-lispify "pango_layout_set_justify" 'function)) :void
  (layout :pointer)
  (justify :int))

(cl:export '#.(swig-lispify "pango_layout_set_justify" 'function))

(cffi:defcfun ("pango_layout_get_justify" #.(swig-lispify "pango_layout_get_justify" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_justify" 'function))

(cffi:defcfun ("pango_layout_set_justify_last_line" #.(swig-lispify "pango_layout_set_justify_last_line" 'function)) :void
  (layout :pointer)
  (justify :int))

(cl:export '#.(swig-lispify "pango_layout_set_justify_last_line" 'function))

(cffi:defcfun ("pango_layout_get_justify_last_line" #.(swig-lispify "pango_layout_get_justify_last_line" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_justify_last_line" 'function))

(cffi:defcfun ("pango_layout_set_auto_dir" #.(swig-lispify "pango_layout_set_auto_dir" 'function)) :void
  (layout :pointer)
  (auto_dir :int))

(cl:export '#.(swig-lispify "pango_layout_set_auto_dir" 'function))

(cffi:defcfun ("pango_layout_get_auto_dir" #.(swig-lispify "pango_layout_get_auto_dir" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_auto_dir" 'function))

(cffi:defcfun ("pango_layout_set_alignment" #.(swig-lispify "pango_layout_set_alignment" 'function)) :void
  (layout :pointer)
  (alignment #.(swig-lispify "PangoAlignment" 'enumname)))

(cl:export '#.(swig-lispify "pango_layout_set_alignment" 'function))

(cffi:defcfun ("pango_layout_get_alignment" #.(swig-lispify "pango_layout_get_alignment" 'function)) #.(swig-lispify "PangoAlignment" 'enumname)
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_alignment" 'function))

(cffi:defcfun ("pango_layout_set_tabs" #.(swig-lispify "pango_layout_set_tabs" 'function)) :void
  (layout :pointer)
  (tabs :pointer))

(cl:export '#.(swig-lispify "pango_layout_set_tabs" 'function))

(cffi:defcfun ("pango_layout_get_tabs" #.(swig-lispify "pango_layout_get_tabs" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_tabs" 'function))

(cffi:defcfun ("pango_layout_set_single_paragraph_mode" #.(swig-lispify "pango_layout_set_single_paragraph_mode" 'function)) :void
  (layout :pointer)
  (setting :int))

(cl:export '#.(swig-lispify "pango_layout_set_single_paragraph_mode" 'function))

(cffi:defcfun ("pango_layout_get_single_paragraph_mode" #.(swig-lispify "pango_layout_get_single_paragraph_mode" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_single_paragraph_mode" 'function))

(cffi:defcfun ("pango_layout_set_ellipsize" #.(swig-lispify "pango_layout_set_ellipsize" 'function)) :void
  (layout :pointer)
  (ellipsize #.(swig-lispify "PangoEllipsizeMode" 'enumname)))

(cl:export '#.(swig-lispify "pango_layout_set_ellipsize" 'function))

(cffi:defcfun ("pango_layout_get_ellipsize" #.(swig-lispify "pango_layout_get_ellipsize" 'function)) #.(swig-lispify "PangoEllipsizeMode" 'enumname)
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_ellipsize" 'function))

(cffi:defcfun ("pango_layout_is_ellipsized" #.(swig-lispify "pango_layout_is_ellipsized" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_is_ellipsized" 'function))

(cffi:defcfun ("pango_layout_get_unknown_glyphs_count" #.(swig-lispify "pango_layout_get_unknown_glyphs_count" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_unknown_glyphs_count" 'function))

(cffi:defcfun ("pango_layout_get_direction" #.(swig-lispify "pango_layout_get_direction" 'function)) #.(swig-lispify "PangoDirection" 'enumname)
  (layout :pointer)
  (index :int))

(cl:export '#.(swig-lispify "pango_layout_get_direction" 'function))

(cffi:defcfun ("pango_layout_context_changed" #.(swig-lispify "pango_layout_context_changed" 'function)) :void
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_context_changed" 'function))

(cffi:defcfun ("pango_layout_get_serial" #.(swig-lispify "pango_layout_get_serial" 'function)) :unsigned-int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_serial" 'function))

(cffi:defcfun ("pango_layout_get_log_attrs" #.(swig-lispify "pango_layout_get_log_attrs" 'function)) :void
  (layout :pointer)
  (attrs :pointer)
  (n_attrs :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_log_attrs" 'function))

(cffi:defcfun ("pango_layout_get_log_attrs_readonly" #.(swig-lispify "pango_layout_get_log_attrs_readonly" 'function)) :pointer
  (layout :pointer)
  (n_attrs :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_log_attrs_readonly" 'function))

(cffi:defcfun ("pango_layout_index_to_pos" #.(swig-lispify "pango_layout_index_to_pos" 'function)) :void
  (layout :pointer)
  (index_ :int)
  (pos :pointer))

(cl:export '#.(swig-lispify "pango_layout_index_to_pos" 'function))

(cffi:defcfun ("pango_layout_index_to_line_x" #.(swig-lispify "pango_layout_index_to_line_x" 'function)) :void
  (layout :pointer)
  (index_ :int)
  (trailing :int)
  (line :pointer)
...
(cl:export '#.(swig-lispify "pango_layout_index_to_line_x" 'function))

(cffi:defcfun ("pango_layout_get_cursor_pos" #.(swig-lispify "pango_layout_get_cursor_pos" 'function)) :void
  (layout :pointer)
  (index_ :int)
  (strong_pos :pointer)
  (weak_pos :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_cursor_pos" 'function))

(cffi:defcfun ("pango_layout_get_caret_pos" #.(swig-lispify "pango_layout_get_caret_pos" 'function)) :void
  (layout :pointer)
  (index_ :int)
  (strong_pos :pointer)
  (weak_pos :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_caret_pos" 'function))

(cffi:defcfun ("pango_layout_move_cursor_visually" #.(swig-lispify "pango_layout_move_cursor_visually" 'function)) :void
  (layout :pointer)
  (strong :int)
  (old_index :int)
  (old_trailing :int)
...
(cl:export '#.(swig-lispify "pango_layout_move_cursor_visually" 'function))

(cffi:defcfun ("pango_layout_xy_to_index" #.(swig-lispify "pango_layout_xy_to_index" 'function)) :int
  (layout :pointer)
  (x :int)
  (y :int)
  (index_ :pointer)
...
(cl:export '#.(swig-lispify "pango_layout_xy_to_index" 'function))

(cffi:defcfun ("pango_layout_get_extents" #.(swig-lispify "pango_layout_get_extents" 'function)) :void
  (layout :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_extents" 'function))

(cffi:defcfun ("pango_layout_get_pixel_extents" #.(swig-lispify "pango_layout_get_pixel_extents" 'function)) :void
  (layout :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_pixel_extents" 'function))

(cffi:defcfun ("pango_layout_get_size" #.(swig-lispify "pango_layout_get_size" 'function)) :void
  (layout :pointer)
  (width :pointer)
  (height :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_size" 'function))

(cffi:defcfun ("pango_layout_get_pixel_size" #.(swig-lispify "pango_layout_get_pixel_size" 'function)) :void
  (layout :pointer)
  (width :pointer)
  (height :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_pixel_size" 'function))

(cffi:defcfun ("pango_layout_get_baseline" #.(swig-lispify "pango_layout_get_baseline" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_baseline" 'function))

(cffi:defcfun ("pango_layout_get_line_count" #.(swig-lispify "pango_layout_get_line_count" 'function)) :int
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_line_count" 'function))

(cffi:defcfun ("pango_layout_get_line" #.(swig-lispify "pango_layout_get_line" 'function)) :pointer
  (layout :pointer)
  (line :int))

(cl:export '#.(swig-lispify "pango_layout_get_line" 'function))

(cffi:defcfun ("pango_layout_get_line_readonly" #.(swig-lispify "pango_layout_get_line_readonly" 'function)) :pointer
  (layout :pointer)
  (line :int))

(cl:export '#.(swig-lispify "pango_layout_get_line_readonly" 'function))

(cffi:defcfun ("pango_layout_get_lines" #.(swig-lispify "pango_layout_get_lines" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_lines" 'function))

(cffi:defcfun ("pango_layout_get_lines_readonly" #.(swig-lispify "pango_layout_get_lines_readonly" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_lines_readonly" 'function))
...
(cffi:defcfun ("pango_layout_serialize" #.(swig-lispify "pango_layout_serialize" 'function)) :pointer
  (layout :pointer)
  (flags #.(swig-lispify "PangoLayoutSerializeFlags" 'enumname)))

(cl:export '#.(swig-lispify "pango_layout_serialize" 'function))

(cffi:defcfun ("pango_layout_write_to_file" #.(swig-lispify "pango_layout_write_to_file" 'function)) :int
  (layout :pointer)
  (flags #.(swig-lispify "PangoLayoutSerializeFlags" 'enumname))
  (filename :string)
  (error :pointer))

(cl:export '#.(swig-lispify "pango_layout_write_to_file" 'function))
...
(cffi:defcfun ("pango_layout_deserialize_error_quark" #.(swig-lispify "pango_layout_deserialize_error_quark" 'function)) :unsigned-int)

(cl:export '#.(swig-lispify "pango_layout_deserialize_error_quark" 'function))
...
(cffi:defcfun ("pango_layout_deserialize" #.(swig-lispify "pango_layout_deserialize" 'function)) :pointer
  (context :pointer)
  (bytes :pointer)
  (flags #.(swig-lispify "PangoLayoutDeserializeFlags" 'enumname))
  (error :pointer))

(cl:export '#.(swig-lispify "pango_layout_deserialize" 'function))

(cffi:defcfun ("pango_layout_line_get_type" #.(swig-lispify "pango_layout_line_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_layout_line_get_type" 'function))

(cffi:defcfun ("pango_layout_line_ref" #.(swig-lispify "pango_layout_line_ref" 'function)) :pointer
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_ref" 'function))

(cffi:defcfun ("pango_layout_line_unref" #.(swig-lispify "pango_layout_line_unref" 'function)) :void
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_unref" 'function))

(cffi:defcfun ("pango_layout_line_get_start_index" #.(swig-lispify "pango_layout_line_get_start_index" 'function)) :int
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_start_index" 'function))

(cffi:defcfun ("pango_layout_line_get_length" #.(swig-lispify "pango_layout_line_get_length" 'function)) :int
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_length" 'function))

(cffi:defcfun ("pango_layout_line_is_paragraph_start" #.(swig-lispify "pango_layout_line_is_paragraph_start" 'function)) :int
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_is_paragraph_start" 'function))

(cffi:defcfun ("pango_layout_line_get_resolved_direction" #.(swig-lispify "pango_layout_line_get_resolved_direction" 'function)) #.(swig-lispify "PangoDirection" 'enumname)
  (line :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_resolved_direction" 'function))

(cffi:defcfun ("pango_layout_line_x_to_index" #.(swig-lispify "pango_layout_line_x_to_index" 'function)) :int
  (line :pointer)
  (x_pos :int)
  (index_ :pointer)
  (trailing :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_x_to_index" 'function))

(cffi:defcfun ("pango_layout_line_index_to_x" #.(swig-lispify "pango_layout_line_index_to_x" 'function)) :void
  (line :pointer)
  (index_ :int)
  (trailing :int)
  (x_pos :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_index_to_x" 'function))

(cffi:defcfun ("pango_layout_line_get_x_ranges" #.(swig-lispify "pango_layout_line_get_x_ranges" 'function)) :void
  (line :pointer)
  (start_index :int)
  (end_index :int)
  (ranges :pointer)
...
(cl:export '#.(swig-lispify "pango_layout_line_get_x_ranges" 'function))

(cffi:defcfun ("pango_layout_line_get_extents" #.(swig-lispify "pango_layout_line_get_extents" 'function)) :void
  (line :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_extents" 'function))

(cffi:defcfun ("pango_layout_line_get_height" #.(swig-lispify "pango_layout_line_get_height" 'function)) :void
  (line :pointer)
  (height :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_height" 'function))

(cffi:defcfun ("pango_layout_line_get_pixel_extents" #.(swig-lispify "pango_layout_line_get_pixel_extents" 'function)) :void
  (layout_line :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_line_get_pixel_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_type" #.(swig-lispify "pango_layout_iter_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_layout_iter_get_type" 'function))

(cffi:defcfun ("pango_layout_get_iter" #.(swig-lispify "pango_layout_get_iter" 'function)) :pointer
  (layout :pointer))

(cl:export '#.(swig-lispify "pango_layout_get_iter" 'function))

(cffi:defcfun ("pango_layout_iter_copy" #.(swig-lispify "pango_layout_iter_copy" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_copy" 'function))

(cffi:defcfun ("pango_layout_iter_free" #.(swig-lispify "pango_layout_iter_free" 'function)) :void
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_free" 'function))

(cffi:defcfun ("pango_layout_iter_get_index" #.(swig-lispify "pango_layout_iter_get_index" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_index" 'function))

(cffi:defcfun ("pango_layout_iter_get_run" #.(swig-lispify "pango_layout_iter_get_run" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_run" 'function))

(cffi:defcfun ("pango_layout_iter_get_run_readonly" #.(swig-lispify "pango_layout_iter_get_run_readonly" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_run_readonly" 'function))

(cffi:defcfun ("pango_layout_iter_get_line" #.(swig-lispify "pango_layout_iter_get_line" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_line" 'function))

(cffi:defcfun ("pango_layout_iter_get_line_readonly" #.(swig-lispify "pango_layout_iter_get_line_readonly" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_line_readonly" 'function))

(cffi:defcfun ("pango_layout_iter_at_last_line" #.(swig-lispify "pango_layout_iter_at_last_line" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_at_last_line" 'function))

(cffi:defcfun ("pango_layout_iter_get_layout" #.(swig-lispify "pango_layout_iter_get_layout" 'function)) :pointer
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_layout" 'function))

(cffi:defcfun ("pango_layout_iter_next_char" #.(swig-lispify "pango_layout_iter_next_char" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_next_char" 'function))

(cffi:defcfun ("pango_layout_iter_next_cluster" #.(swig-lispify "pango_layout_iter_next_cluster" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_next_cluster" 'function))

(cffi:defcfun ("pango_layout_iter_next_run" #.(swig-lispify "pango_layout_iter_next_run" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_next_run" 'function))

(cffi:defcfun ("pango_layout_iter_next_line" #.(swig-lispify "pango_layout_iter_next_line" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_next_line" 'function))

(cffi:defcfun ("pango_layout_iter_get_char_extents" #.(swig-lispify "pango_layout_iter_get_char_extents" 'function)) :void
  (iter :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_char_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_cluster_extents" #.(swig-lispify "pango_layout_iter_get_cluster_extents" 'function)) :void
  (iter :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_cluster_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_run_extents" #.(swig-lispify "pango_layout_iter_get_run_extents" 'function)) :void
  (iter :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_run_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_line_extents" #.(swig-lispify "pango_layout_iter_get_line_extents" 'function)) :void
  (iter :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_line_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_line_yrange" #.(swig-lispify "pango_layout_iter_get_line_yrange" 'function)) :void
  (iter :pointer)
  (y0_ :pointer)
  (y1_ :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_line_yrange" 'function))

(cffi:defcfun ("pango_layout_iter_get_layout_extents" #.(swig-lispify "pango_layout_iter_get_layout_extents" 'function)) :void
  (iter :pointer)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_layout_extents" 'function))

(cffi:defcfun ("pango_layout_iter_get_baseline" #.(swig-lispify "pango_layout_iter_get_baseline" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_baseline" 'function))

(cffi:defcfun ("pango_layout_iter_get_run_baseline" #.(swig-lispify "pango_layout_iter_get_run_baseline" 'function)) :int
  (iter :pointer))

(cl:export '#.(swig-lispify "pango_layout_iter_get_run_baseline" 'function))
