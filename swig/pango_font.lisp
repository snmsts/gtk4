...
(uiop/package:define-package :gtk4/swig/pango_font
  (:use :cl :cffi :gtk4/swig-wrap)
  (:nicknames :gtk4/pango_font)
  (:export
   ))
(in-package :gtk4/swig/pango_font)
...
(cffi:defcfun ("pango_font_description_get_type" #.(swig-lispify "pango_font_description_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_description_get_type" 'function))

(cffi:defcfun ("pango_font_description_new" #.(swig-lispify "pango_font_description_new" 'function)) :pointer)

(cl:export '#.(swig-lispify "pango_font_description_new" 'function))

(cffi:defcfun ("pango_font_description_copy" #.(swig-lispify "pango_font_description_copy" 'function)) :pointer
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_copy" 'function))

(cffi:defcfun ("pango_font_description_copy_static" #.(swig-lispify "pango_font_description_copy_static" 'function)) :pointer
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_copy_static" 'function))

(cffi:defcfun ("pango_font_description_hash" #.(swig-lispify "pango_font_description_hash" 'function)) :unsigned-int
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_hash" 'function))

(cffi:defcfun ("pango_font_description_equal" #.(swig-lispify "pango_font_description_equal" 'function)) :int
  (desc1 :pointer)
  (desc2 :pointer))

(cl:export '#.(swig-lispify "pango_font_description_equal" 'function))

(cffi:defcfun ("pango_font_description_free" #.(swig-lispify "pango_font_description_free" 'function)) :void
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_free" 'function))

(cffi:defcfun ("pango_font_descriptions_free" #.(swig-lispify "pango_font_descriptions_free" 'function)) :void
  (descs :pointer)
  (n_descs :int))

(cl:export '#.(swig-lispify "pango_font_descriptions_free" 'function))

(cffi:defcfun ("pango_font_description_set_family" #.(swig-lispify "pango_font_description_set_family" 'function)) :void
  (desc :pointer)
  (family :string))

(cl:export '#.(swig-lispify "pango_font_description_set_family" 'function))

(cffi:defcfun ("pango_font_description_set_family_static" #.(swig-lispify "pango_font_description_set_family_static" 'function)) :void
  (desc :pointer)
  (family :string))

(cl:export '#.(swig-lispify "pango_font_description_set_family_static" 'function))

(cffi:defcfun ("pango_font_description_get_family" #.(swig-lispify "pango_font_description_get_family" 'function)) :string
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_family" 'function))

(cffi:defcfun ("pango_font_description_set_style" #.(swig-lispify "pango_font_description_set_style" 'function)) :void
  (desc :pointer)
  (style #.(swig-lispify "PangoStyle" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_set_style" 'function))

(cffi:defcfun ("pango_font_description_get_style" #.(swig-lispify "pango_font_description_get_style" 'function)) #.(swig-lispify "PangoStyle" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_style" 'function))

(cffi:defcfun ("pango_font_description_set_variant" #.(swig-lispify "pango_font_description_set_variant" 'function)) :void
  (desc :pointer)
  (variant #.(swig-lispify "PangoVariant" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_set_variant" 'function))

(cffi:defcfun ("pango_font_description_get_variant" #.(swig-lispify "pango_font_description_get_variant" 'function)) #.(swig-lispify "PangoVariant" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_variant" 'function))

(cffi:defcfun ("pango_font_description_set_weight" #.(swig-lispify "pango_font_description_set_weight" 'function)) :void
  (desc :pointer)
  (weight #.(swig-lispify "PangoWeight" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_set_weight" 'function))

(cffi:defcfun ("pango_font_description_get_weight" #.(swig-lispify "pango_font_description_get_weight" 'function)) #.(swig-lispify "PangoWeight" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_weight" 'function))

(cffi:defcfun ("pango_font_description_set_stretch" #.(swig-lispify "pango_font_description_set_stretch" 'function)) :void
  (desc :pointer)
  (stretch #.(swig-lispify "PangoStretch" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_set_stretch" 'function))

(cffi:defcfun ("pango_font_description_get_stretch" #.(swig-lispify "pango_font_description_get_stretch" 'function)) #.(swig-lispify "PangoStretch" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_stretch" 'function))

(cffi:defcfun ("pango_font_description_set_size" #.(swig-lispify "pango_font_description_set_size" 'function)) :void
  (desc :pointer)
  (size :int))

(cl:export '#.(swig-lispify "pango_font_description_set_size" 'function))

(cffi:defcfun ("pango_font_description_get_size" #.(swig-lispify "pango_font_description_get_size" 'function)) :int
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_size" 'function))

(cffi:defcfun ("pango_font_description_set_absolute_size" #.(swig-lispify "pango_font_description_set_absolute_size" 'function)) :void
  (desc :pointer)
  (size :double))

(cl:export '#.(swig-lispify "pango_font_description_set_absolute_size" 'function))

(cffi:defcfun ("pango_font_description_get_size_is_absolute" #.(swig-lispify "pango_font_description_get_size_is_absolute" 'function)) :int
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_size_is_absolute" 'function))

(cffi:defcfun ("pango_font_description_set_gravity" #.(swig-lispify "pango_font_description_set_gravity" 'function)) :void
  (desc :pointer)
  (gravity #.(swig-lispify "PangoGravity" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_set_gravity" 'function))

(cffi:defcfun ("pango_font_description_get_gravity" #.(swig-lispify "pango_font_description_get_gravity" 'function)) #.(swig-lispify "PangoGravity" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_gravity" 'function))

(cffi:defcfun ("pango_font_description_set_variations_static" #.(swig-lispify "pango_font_description_set_variations_static" 'function)) :void
  (desc :pointer)
  (variations :string))

(cl:export '#.(swig-lispify "pango_font_description_set_variations_static" 'function))

(cffi:defcfun ("pango_font_description_set_variations" #.(swig-lispify "pango_font_description_set_variations" 'function)) :void
  (desc :pointer)
  (variations :string))

(cl:export '#.(swig-lispify "pango_font_description_set_variations" 'function))

(cffi:defcfun ("pango_font_description_get_variations" #.(swig-lispify "pango_font_description_get_variations" 'function)) :string
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_variations" 'function))

(cffi:defcfun ("pango_font_description_get_set_fields" #.(swig-lispify "pango_font_description_get_set_fields" 'function)) #.(swig-lispify "PangoFontMask" 'enumname)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_get_set_fields" 'function))

(cffi:defcfun ("pango_font_description_unset_fields" #.(swig-lispify "pango_font_description_unset_fields" 'function)) :void
  (desc :pointer)
  (to_unset #.(swig-lispify "PangoFontMask" 'enumname)))

(cl:export '#.(swig-lispify "pango_font_description_unset_fields" 'function))

(cffi:defcfun ("pango_font_description_merge" #.(swig-lispify "pango_font_description_merge" 'function)) :void
  (desc :pointer)
  (desc_to_merge :pointer)
  (replace_existing :int))

(cl:export '#.(swig-lispify "pango_font_description_merge" 'function))

(cffi:defcfun ("pango_font_description_merge_static" #.(swig-lispify "pango_font_description_merge_static" 'function)) :void
  (desc :pointer)
  (desc_to_merge :pointer)
  (replace_existing :int))

(cl:export '#.(swig-lispify "pango_font_description_merge_static" 'function))

(cffi:defcfun ("pango_font_description_better_match" #.(swig-lispify "pango_font_description_better_match" 'function)) :int
  (desc :pointer)
  (old_match :pointer)
  (new_match :pointer))

(cl:export '#.(swig-lispify "pango_font_description_better_match" 'function))

(cffi:defcfun ("pango_font_description_from_string" #.(swig-lispify "pango_font_description_from_string" 'function)) :pointer
  (str :string))

(cl:export '#.(swig-lispify "pango_font_description_from_string" 'function))

(cffi:defcfun ("pango_font_description_to_string" #.(swig-lispify "pango_font_description_to_string" 'function)) :string
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_to_string" 'function))

(cffi:defcfun ("pango_font_description_to_filename" #.(swig-lispify "pango_font_description_to_filename" 'function)) :string
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_description_to_filename" 'function))

(cffi:defcstruct #.(swig-lispify "_PangoFontMetrics" 'classname)
	(#.(swig-lispify "ref_count" 'slotname) :unsigned-int)
	(#.(swig-lispify "ascent" 'slotname) :int)
	(#.(swig-lispify "descent" 'slotname) :int)
	(#.(swig-lispify "height" 'slotname) :int)
	(#.(swig-lispify "approximate_char_width" 'slotname) :int)
	(#.(swig-lispify "approximate_digit_width" 'slotname) :int)
	(#.(swig-lispify "underline_position" 'slotname) :int)
	(#.(swig-lispify "underline_thickness" 'slotname) :int)
	(#.(swig-lispify "strikethrough_position" 'slotname) :int)
	(#.(swig-lispify "strikethrough_thickness" 'slotname) :int))

(cl:export '#.(swig-lispify "_PangoFontMetrics" 'classname))

(cl:export '#.(swig-lispify "ref_count" 'slotname))
...
(cl:export '#.(swig-lispify "approximate_char_width" 'slotname))

(cl:export '#.(swig-lispify "approximate_digit_width" 'slotname))

(cl:export '#.(swig-lispify "underline_position" 'slotname))

(cl:export '#.(swig-lispify "underline_thickness" 'slotname))

(cl:export '#.(swig-lispify "strikethrough_position" 'slotname))

(cl:export '#.(swig-lispify "strikethrough_thickness" 'slotname))

(cffi:defcfun ("pango_font_metrics_get_type" #.(swig-lispify "pango_font_metrics_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_metrics_get_type" 'function))

(cffi:defcfun ("pango_font_metrics_ref" #.(swig-lispify "pango_font_metrics_ref" 'function)) :pointer
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_ref" 'function))

(cffi:defcfun ("pango_font_metrics_unref" #.(swig-lispify "pango_font_metrics_unref" 'function)) :void
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_unref" 'function))

(cffi:defcfun ("pango_font_metrics_get_ascent" #.(swig-lispify "pango_font_metrics_get_ascent" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_ascent" 'function))

(cffi:defcfun ("pango_font_metrics_get_descent" #.(swig-lispify "pango_font_metrics_get_descent" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_descent" 'function))

(cffi:defcfun ("pango_font_metrics_get_height" #.(swig-lispify "pango_font_metrics_get_height" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_height" 'function))

(cffi:defcfun ("pango_font_metrics_get_approximate_char_width" #.(swig-lispify "pango_font_metrics_get_approximate_char_width" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_approximate_char_width" 'function))

(cffi:defcfun ("pango_font_metrics_get_approximate_digit_width" #.(swig-lispify "pango_font_metrics_get_approximate_digit_width" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_approximate_digit_width" 'function))

(cffi:defcfun ("pango_font_metrics_get_underline_position" #.(swig-lispify "pango_font_metrics_get_underline_position" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_underline_position" 'function))

(cffi:defcfun ("pango_font_metrics_get_underline_thickness" #.(swig-lispify "pango_font_metrics_get_underline_thickness" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_underline_thickness" 'function))

(cffi:defcfun ("pango_font_metrics_get_strikethrough_position" #.(swig-lispify "pango_font_metrics_get_strikethrough_position" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_strikethrough_position" 'function))

(cffi:defcfun ("pango_font_metrics_get_strikethrough_thickness" #.(swig-lispify "pango_font_metrics_get_strikethrough_thickness" 'function)) :int
  (metrics :pointer))

(cl:export '#.(swig-lispify "pango_font_metrics_get_strikethrough_thickness" 'function))

(cffi:defcstruct #.(swig-lispify "_PangoFontFamily" 'classname)
	(#.(swig-lispify "parent_instance" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontFamily" 'classname))

(cl:export '#.(swig-lispify "parent_instance" 'slotname))

(cffi:defcstruct #.(swig-lispify "_PangoFontFamilyClass" 'classname)
	(#.(swig-lispify "parent_class" 'slotname) :pointer)
	(#.(swig-lispify "list_faces" 'slotname) :pointer)
	(#.(swig-lispify "get_name" 'slotname) :pointer)
	(#.(swig-lispify "is_monospace" 'slotname) :pointer)
	(#.(swig-lispify "is_variable" 'slotname) :pointer)
	(#.(swig-lispify "get_face" 'slotname) :pointer)
	(#.(swig-lispify "_pango_reserved2" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontFamilyClass" 'classname))

(cl:export '#.(swig-lispify "parent_class" 'slotname))

(cl:export '#.(swig-lispify "list_faces" 'slotname))

(cl:export '#.(swig-lispify "get_name" 'slotname))

(cl:export '#.(swig-lispify "is_monospace" 'slotname))

(cl:export '#.(swig-lispify "is_variable" 'slotname))

(cl:export '#.(swig-lispify "get_face" 'slotname))

(cl:export '#.(swig-lispify "_pango_reserved2" 'slotname))

(cffi:defcfun ("pango_font_family_get_type" #.(swig-lispify "pango_font_family_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_family_get_type" 'function))

(cffi:defcfun ("pango_font_family_list_faces" #.(swig-lispify "pango_font_family_list_faces" 'function)) :void
  (family :pointer)
  (faces :pointer)
  (n_faces :pointer))

(cl:export '#.(swig-lispify "pango_font_family_list_faces" 'function))

(cffi:defcfun ("pango_font_family_get_name" #.(swig-lispify "pango_font_family_get_name" 'function)) :string
  (family :pointer))

(cl:export '#.(swig-lispify "pango_font_family_get_name" 'function))

(cffi:defcfun ("pango_font_family_is_monospace" #.(swig-lispify "pango_font_family_is_monospace" 'function)) :int
  (family :pointer))

(cl:export '#.(swig-lispify "pango_font_family_is_monospace" 'function))

(cffi:defcfun ("pango_font_family_is_variable" #.(swig-lispify "pango_font_family_is_variable" 'function)) :int
  (family :pointer))

(cl:export '#.(swig-lispify "pango_font_family_is_variable" 'function))

(cffi:defcfun ("pango_font_family_get_face" #.(swig-lispify "pango_font_family_get_face" 'function)) :pointer
  (family :pointer)
  (name :string))

(cl:export '#.(swig-lispify "pango_font_family_get_face" 'function))

(cffi:defcstruct #.(swig-lispify "_PangoFontFace" 'classname)
	(#.(swig-lispify "parent_instance" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontFace" 'classname))

(cl:export '#.(swig-lispify "parent_instance" 'slotname))

(cffi:defcstruct #.(swig-lispify "_PangoFontFaceClass" 'classname)
	(#.(swig-lispify "parent_class" 'slotname) :pointer)
	(#.(swig-lispify "get_face_name" 'slotname) :pointer)
	(#.(swig-lispify "describe" 'slotname) :pointer)
	(#.(swig-lispify "list_sizes" 'slotname) :pointer)
	(#.(swig-lispify "is_synthesized" 'slotname) :pointer)
	(#.(swig-lispify "get_family" 'slotname) :pointer)
	(#.(swig-lispify "_pango_reserved3" 'slotname) :pointer)
	(#.(swig-lispify "_pango_reserved4" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontFaceClass" 'classname))

(cl:export '#.(swig-lispify "parent_class" 'slotname))

(cl:export '#.(swig-lispify "get_face_name" 'slotname))

(cl:export '#.(swig-lispify "describe" 'slotname))

(cl:export '#.(swig-lispify "list_sizes" 'slotname))

(cl:export '#.(swig-lispify "is_synthesized" 'slotname))

(cl:export '#.(swig-lispify "get_family" 'slotname))

(cl:export '#.(swig-lispify "_pango_reserved3" 'slotname))

(cl:export '#.(swig-lispify "_pango_reserved4" 'slotname))

(cffi:defcfun ("pango_font_face_get_type" #.(swig-lispify "pango_font_face_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_face_get_type" 'function))

(cffi:defcfun ("pango_font_face_describe" #.(swig-lispify "pango_font_face_describe" 'function)) :pointer
  (face :pointer))

(cl:export '#.(swig-lispify "pango_font_face_describe" 'function))

(cffi:defcfun ("pango_font_face_get_face_name" #.(swig-lispify "pango_font_face_get_face_name" 'function)) :string
  (face :pointer))

(cl:export '#.(swig-lispify "pango_font_face_get_face_name" 'function))

(cffi:defcfun ("pango_font_face_list_sizes" #.(swig-lispify "pango_font_face_list_sizes" 'function)) :void
  (face :pointer)
  (sizes :pointer)
  (n_sizes :pointer))

(cl:export '#.(swig-lispify "pango_font_face_list_sizes" 'function))

(cffi:defcfun ("pango_font_face_is_synthesized" #.(swig-lispify "pango_font_face_is_synthesized" 'function)) :int
  (face :pointer))

(cl:export '#.(swig-lispify "pango_font_face_is_synthesized" 'function))

(cffi:defcfun ("pango_font_face_get_family" #.(swig-lispify "pango_font_face_get_family" 'function)) :pointer
  (face :pointer))

(cl:export '#.(swig-lispify "pango_font_face_get_family" 'function))

(cffi:defcstruct #.(swig-lispify "_PangoFont" 'classname)
	(#.(swig-lispify "parent_instance" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFont" 'classname))

(cl:export '#.(swig-lispify "parent_instance" 'slotname))

(cffi:defcstruct #.(swig-lispify "_PangoFontClass" 'classname)
	(#.(swig-lispify "parent_class" 'slotname) :pointer)
	(#.(swig-lispify "describe" 'slotname) :pointer)
	(#.(swig-lispify "get_coverage" 'slotname) :pointer)
	(#.(swig-lispify "get_glyph_extents" 'slotname) :pointer)
	(#.(swig-lispify "get_metrics" 'slotname) :pointer)
	(#.(swig-lispify "get_font_map" 'slotname) :pointer)
	(#.(swig-lispify "describe_absolute" 'slotname) :pointer)
	(#.(swig-lispify "get_features" 'slotname) :pointer)
	(#.(swig-lispify "create_hb_font" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontClass" 'classname))

(cl:export '#.(swig-lispify "parent_class" 'slotname))

(cl:export '#.(swig-lispify "describe" 'slotname))

(cl:export '#.(swig-lispify "get_coverage" 'slotname))

(cl:export '#.(swig-lispify "get_glyph_extents" 'slotname))

(cl:export '#.(swig-lispify "get_metrics" 'slotname))

(cl:export '#.(swig-lispify "get_font_map" 'slotname))

(cl:export '#.(swig-lispify "describe_absolute" 'slotname))

(cl:export '#.(swig-lispify "get_features" 'slotname))

(cl:export '#.(swig-lispify "create_hb_font" 'slotname))

(cffi:defcfun ("pango_font_get_type" #.(swig-lispify "pango_font_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_get_type" 'function))

(cffi:defcfun ("pango_font_describe" #.(swig-lispify "pango_font_describe" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_describe" 'function))

(cffi:defcfun ("pango_font_describe_with_absolute_size" #.(swig-lispify "pango_font_describe_with_absolute_size" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_describe_with_absolute_size" 'function))

(cffi:defcfun ("pango_font_get_coverage" #.(swig-lispify "pango_font_get_coverage" 'function)) :pointer
  (font :pointer)
  (language :pointer))

(cl:export '#.(swig-lispify "pango_font_get_coverage" 'function))

(cffi:defcfun ("pango_font_find_shaper" #.(swig-lispify "pango_font_find_shaper" 'function)) :pointer
  (font :pointer)
  (language :pointer)
  (ch :unsigned-int))

(cl:export '#.(swig-lispify "pango_font_find_shaper" 'function))

(cffi:defcfun ("pango_font_get_metrics" #.(swig-lispify "pango_font_get_metrics" 'function)) :pointer
  (font :pointer)
  (language :pointer))

(cl:export '#.(swig-lispify "pango_font_get_metrics" 'function))

(cffi:defcfun ("pango_font_get_glyph_extents" #.(swig-lispify "pango_font_get_glyph_extents" 'function)) :void
  (font :pointer)
  (glyph :unsigned-int)
  (ink_rect :pointer)
  (logical_rect :pointer))

(cl:export '#.(swig-lispify "pango_font_get_glyph_extents" 'function))

(cffi:defcfun ("pango_font_get_font_map" #.(swig-lispify "pango_font_get_font_map" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_get_font_map" 'function))

(cffi:defcfun ("pango_font_get_face" #.(swig-lispify "pango_font_get_face" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_get_face" 'function))

(cffi:defcfun ("pango_font_has_char" #.(swig-lispify "pango_font_has_char" 'function)) :int
  (font :pointer)
  (wc :unsigned-int))

(cl:export '#.(swig-lispify "pango_font_has_char" 'function))

(cffi:defcfun ("pango_font_get_features" #.(swig-lispify "pango_font_get_features" 'function)) :void
  (font :pointer)
  (features :pointer)
  (len :unsigned-int)
  (num_features :pointer))

(cl:export '#.(swig-lispify "pango_font_get_features" 'function))

(cffi:defcfun ("pango_font_get_hb_font" #.(swig-lispify "pango_font_get_hb_font" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_get_hb_font" 'function))

(cffi:defcfun ("pango_font_get_languages" #.(swig-lispify "pango_font_get_languages" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_get_languages" 'function))

(cffi:defcfun ("pango_font_serialize" #.(swig-lispify "pango_font_serialize" 'function)) :pointer
  (font :pointer))

(cl:export '#.(swig-lispify "pango_font_serialize" 'function))

(cffi:defcfun ("pango_font_deserialize" #.(swig-lispify "pango_font_deserialize" 'function)) :pointer
  (context :pointer)
  (bytes :pointer)
  (error :pointer))

(cl:export '#.(swig-lispify "pango_font_deserialize" 'function))

(cl:defconstant #.(swig-lispify "PANGO_UNKNOWN_GLYPH_WIDTH" 'constant) 10)

(cl:export '#.(swig-lispify "PANGO_UNKNOWN_GLYPH_WIDTH" 'constant))

(cl:defconstant #.(swig-lispify "PANGO_UNKNOWN_GLYPH_HEIGHT" 'constant) 14)

(cl:export '#.(swig-lispify "PANGO_UNKNOWN_GLYPH_HEIGHT" 'constant))
