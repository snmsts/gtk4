...
(uiop/package:define-package :gtk4/swig/pango_fontmap
  (:use :cl :cffi :gtk4/swig-wrap)
  (:nicknames :gtk4/pango_fontmap)
  (:export
   ))
(in-package :gtk4/swig/pango_fontmap)
...
(cffi:defcstruct #.(swig-lispify "_PangoFontMap" 'classname)
	(#.(swig-lispify "parent_instance" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontMap" 'classname))

(cl:export '#.(swig-lispify "parent_instance" 'slotname))

(cffi:defcstruct #.(swig-lispify "_PangoFontMapClass" 'classname)
	(#.(swig-lispify "parent_class" 'slotname) :pointer)
	(#.(swig-lispify "load_font" 'slotname) :pointer)
	(#.(swig-lispify "list_families" 'slotname) :pointer)
	(#.(swig-lispify "load_fontset" 'slotname) :pointer)
	(#.(swig-lispify "shape_engine_type" 'slotname) :string)
	(#.(swig-lispify "get_serial" 'slotname) :pointer)
	(#.(swig-lispify "changed" 'slotname) :pointer)
	(#.(swig-lispify "get_family" 'slotname) :pointer)
	(#.(swig-lispify "get_face" 'slotname) :pointer))

(cl:export '#.(swig-lispify "_PangoFontMapClass" 'classname))

(cl:export '#.(swig-lispify "parent_class" 'slotname))

(cl:export '#.(swig-lispify "load_font" 'slotname))

(cl:export '#.(swig-lispify "list_families" 'slotname))

(cl:export '#.(swig-lispify "load_fontset" 'slotname))

(cl:export '#.(swig-lispify "shape_engine_type" 'slotname))

(cl:export '#.(swig-lispify "get_serial" 'slotname))

(cl:export '#.(swig-lispify "changed" 'slotname))

(cl:export '#.(swig-lispify "get_family" 'slotname))

(cl:export '#.(swig-lispify "get_face" 'slotname))

(cffi:defcfun ("pango_font_map_get_type" #.(swig-lispify "pango_font_map_get_type" 'function)) :unsigned-long)

(cl:export '#.(swig-lispify "pango_font_map_get_type" 'function))

(cffi:defcfun ("pango_font_map_create_context" #.(swig-lispify "pango_font_map_create_context" 'function)) :pointer
  (fontmap :pointer))

(cl:export '#.(swig-lispify "pango_font_map_create_context" 'function))

(cffi:defcfun ("pango_font_map_load_font" #.(swig-lispify "pango_font_map_load_font" 'function)) :pointer
  (fontmap :pointer)
  (context :pointer)
  (desc :pointer))

(cl:export '#.(swig-lispify "pango_font_map_load_font" 'function))

(cffi:defcfun ("pango_font_map_load_fontset" #.(swig-lispify "pango_font_map_load_fontset" 'function)) :pointer
  (fontmap :pointer)
  (context :pointer)
  (desc :pointer)
  (language :pointer))

(cl:export '#.(swig-lispify "pango_font_map_load_fontset" 'function))

(cffi:defcfun ("pango_font_map_list_families" #.(swig-lispify "pango_font_map_list_families" 'function)) :void
  (fontmap :pointer)
  (families :pointer)
  (n_families :pointer))

(cl:export '#.(swig-lispify "pango_font_map_list_families" 'function))

(cffi:defcfun ("pango_font_map_get_serial" #.(swig-lispify "pango_font_map_get_serial" 'function)) :unsigned-int
  (fontmap :pointer))

(cl:export '#.(swig-lispify "pango_font_map_get_serial" 'function))

(cffi:defcfun ("pango_font_map_changed" #.(swig-lispify "pango_font_map_changed" 'function)) :void
  (fontmap :pointer))

(cl:export '#.(swig-lispify "pango_font_map_changed" 'function))

(cffi:defcfun ("pango_font_map_get_family" #.(swig-lispify "pango_font_map_get_family" 'function)) :pointer
  (fontmap :pointer)
  (name :string))

(cl:export '#.(swig-lispify "pango_font_map_get_family" 'function))
