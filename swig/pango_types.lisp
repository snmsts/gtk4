...
(uiop/package:define-package :gtk4/swig/pango_types
  (:use :cl :cffi :gtk4/swig-wrap)
  (:nicknames :gtk4/pango_types)
  (:export
   ))
(in-package :gtk4/swig/pango_types)
...
(cl:defconstant #.(swig-lispify "PANGO_SCALE" 'constant) 1024)

(cl:export '#.(swig-lispify "PANGO_SCALE" 'constant))

(cffi:defcfun ("pango_units_from_double" #.(swig-lispify "pango_units_from_double" 'function)) :int
  (d :double))

(cl:export '#.(swig-lispify "pango_units_from_double" 'function))

(cffi:defcfun ("pango_units_to_double" #.(swig-lispify "pango_units_to_double" 'function)) :double
  (i :int))

(cl:export '#.(swig-lispify "pango_units_to_double" 'function))

(cffi:defcstruct #.(swig-lispify "_PangoRectangle" 'classname)
	(#.(swig-lispify "x" 'slotname) :int)
	(#.(swig-lispify "y" 'slotname) :int)
	(#.(swig-lispify "width" 'slotname) :int)
	(#.(swig-lispify "height" 'slotname) :int))

(cl:export '#.(swig-lispify "_PangoRectangle" 'classname))
...
(cffi:defcfun ("pango_extents_to_pixels" #.(swig-lispify "pango_extents_to_pixels" 'function)) :void
  (inclusive :pointer)
  (nearest :pointer))

(cl:export '#.(swig-lispify "pango_extents_to_pixels" 'function))
